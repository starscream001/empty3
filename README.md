...
- `tests/ui/test_home_navigation.py` — тесты переходов по разделам навигации.
...
## Что проверяют тесты
- Кликают по пунктам навигации («О нас», «Услуги», «Проекты», «Команда», «Карьера», «Контакты»).
- Проверяют появление соответствующего якоря в URL и видимость целевого блока на странице.
